# Autogenerated wrapper script for Edlib_jll for x86_64-unknown-freebsd11.1-cxx11
export libedlib
...
const libedlib_splitpath = ["lib", "libedlib.so"]
...
const libedlib = "libedlib.so.1.2.5"
