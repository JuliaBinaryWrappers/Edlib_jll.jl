...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Edlib_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("9cc87b63-894b-53d6-8750-e9bc5869edd9"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Edlib", artifacts_toml) for e in artifacts["Edlib"]]
...
if best_platform === nothing
    @debug("Unable to load Edlib; unsupported platform $(triplet(platform_key_abi()))")
else
